            ...
            <div class="col-10 p-0">
                ...
                <main>
                    ...
                    if (isset($_SESSION["admin"]) && $_SESSION["admin"] == true) {
                        ...
                        <h1 class="text-center mt-5 mb-5">Voeg Nieuwe Coureur Toe</h1>
                        <form enctype="multipart/form-data" method="post" class="d-flex flex-column justify-content-center w-50">
                            ...
                            <input type="submit" name="voeg_coureur_toe" value="Voeg Nieuwe Coureur Toe" class="btn my-3 btn-lg text-white bg-danger">';
                            toevoegenCoureurs($conn);
                        echo '
                        </form>
                        </section>';
                    }
                    ?>
                    <h1 class="text-center mt-5 mb-5">Coureurs</h1>
